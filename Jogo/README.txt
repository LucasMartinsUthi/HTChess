...
As configurações atuais estão para criar um servidor local e jogar o jogo em dois terminais diferentes no mesmo computador, caso queira testar o jogo entre dois computadores entre no arquivo server.py e mudar a na linha 6 o 'localhost', para o ip do host, a mesa alteração deve ser feita em classe/classJogador.py na linha 79.
